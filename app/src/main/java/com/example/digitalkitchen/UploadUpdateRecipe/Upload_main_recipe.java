...
public class Upload_main_recipe extends AppCompatActivity {
    ...
    private static final String TAG = "Upload_main_recipe";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        home.setOnClickListener(v -> startActivity(new Intent(Upload_main_recipe.this, CategoryRecipeActivity.class)
        ...
        profile.setOnClickListener(v -> startActivity(new Intent(Upload_main_recipe.this, myProfilePage.class)
                .putExtra("name", nameUser)
                .putExtra("email", emailUser)
                .putExtra("username", usernameUser)
                .putExtra("password", passwordUser)
            ...
            storageReference.putFile(uri).addOnSuccessListener(taskSnapshot -> {
                ...
                taskSnapshot.getStorage().getDownloadUrl().addOnCompleteListener(task -> {
                    if (task.isSuccessful()) {
                        ...
                        uploadRecipe(progressDialog);  // להעביר את progressDialog לפונקציה
                    } else {
                        progressDialog.dismiss();
                        Toast.makeText(Upload_main_recipe.this, "העלאת התמונה נכשלה", Toast.LENGTH_SHORT).show();
    ...
    public void uploadRecipe(AlertDialog progressDialog) {
        ...
        FirebaseDatabase.getInstance(Utils.DATABASE_URL).getReference("users")
                .child(usernameUser).child("RecipeMain").child(myCurrentDateTime).setValue(foodData)
                .addOnCompleteListener(task -> {
                    progressDialog.dismiss();
                    if (task.isSuccessful()) {
                        Utils.playSound(this, R.raw.success_sound);
                        Toast.makeText(Upload_main_recipe.this, "המתכון הועלה בהצלחה", Toast.LENGTH_SHORT).show();
                        ...
                        Toast.makeText(Upload_main_recipe.this, "שמירת המתכון נכשלה", Toast.LENGTH_SHORT).show();
